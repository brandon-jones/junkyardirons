...
class MachinesControllerTest < ActionController::TestCase
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post :create, machine: { description: @machine.description, machine_set_id: @machine.machine_set_id, title: @machine.title }
    end
  ...
  test "should update machine" do
    patch :update, id: @machine, machine: { description: @machine.description, machine_set_id: @machine.machine_set_id, title: @machine.title }
    assert_redirected_to machine_path(assigns(:machine))
  end
